...
void loadImages() {
    loadimage(&imgBackground, _T("../img/background.png"), WIDTH, HEIGHT);
    loadimage(&imgWin1, _T("../img/1win.png"), WIDTH, HEIGHT);
    loadimage(&imgWin2, _T("../img/2win.png"), WIDTH, HEIGHT);
}
...
int main() {
    ...
    auto fun = [](int x, int y) { return x + rand() % (y - x + 1); };
    vector<L> drinks;
